            ...
            <div className="content">
                ...
                <div className="hotel-form">
                    <form className='bg-white text-gray-500 rounded-lg px-6 py-4  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
                        ...
                        <button onClick={() =>navigate('/hostels', {state: {filters}})} className='flex items-center justify-center gap-1 rounded-md bg-black py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
